...
const Dex = new class implements ModdedDex {
	...
	getTeambuilderSpriteData(pokemon: any, gen: number = 0): TeambuilderSpriteData {
		...
		spriteData.x = 10;
		spriteData.y = 5;
		if (id == 'pigardoom' || id == 'magopop' || id == 'magopop-mega' || id == 'gymbrock' || id == 'conchity' || id == 'ironjuan' || id == 'prendeporros' || id == 'prendeporros-mega' || id == 'pinkchariot' || id == 'trece' || id == 'trece-mega'
